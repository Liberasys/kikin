...
USING KIKIN
=====================
1) Give a name to this current Ansible instance : ansible-playbook ./ansible_name_instance.yml --inventory=/dev/null
...
For restarting to zero with KICKIN (or quit it :-) :
